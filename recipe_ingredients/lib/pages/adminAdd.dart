  ...
  Widget build(BuildContext context) {
    return Scaffold(
          appBar: AppBar(
            ...
            titleSpacing: 30,
            title: Text("Add a new item",style: TextStyle(fontSize: 30),
            ),
          ),
                      ...
                      children: <Widget>[
                        ...
                        Card(
                          ...
                          (_image!=null)
                              ...
                              :Image(image: AssetImage ('images/add.png'),width: 60,height: 60,)
                        ),
                        InkWell(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        RaisedButton(
                          onPressed: () async {
                            ...
                            _firestore.collection("Items").doc(category).collection(category).add({
                              'url': downloadUrl,
                              'Recipe' : Recipe,
                            ...
                            _firestore.collection("Items").doc(category).set({
                            'dummy': category
